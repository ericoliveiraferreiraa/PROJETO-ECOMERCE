...
- [x] Definição do conceito da Choco World
...
- [ ] Prototipação completa no Figma
...
Projeto desenvolvido para fins acadêmicos na área de **Tecnologia da Informação / Análise e Desenvolvimento de Sistemas**.

**Choco World — Chocolate que transforma.**
